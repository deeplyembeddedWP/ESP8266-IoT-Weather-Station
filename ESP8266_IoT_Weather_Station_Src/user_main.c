...
/* App functions */
static void ICACHE_FLASH_ATTR Read_dht11_data(DHT11_Ptr dhtt_app_Ptr);
static void ICACHE_FLASH_ATTR dht11_app_tmr(DHT11_Ptr dhtt_app_Ptr, os_timer_t *esp_app_timer,
...
user_init ()
{
	...
	dht11_app_tmr(&dht11_obj, &dht11_app_timer, 5000, 1);
}
 ...
 ****************************************************************/
void ICACHE_FLASH_ATTR Read_dht11_data(DHT11_Ptr dhtt_app_Ptr)
{
 ...
 ****************************************************************/
void ICACHE_FLASH_ATTR dht11_app_tmr(DHT11_Ptr dhtt_app_Ptr, os_timer_t *esp_app_timer,
		int timer_app_us, bool app_repeat)
{
